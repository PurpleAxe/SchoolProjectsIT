...
procedure TC3.btnP1Click(Sender: TObject);
begin
P1STATS.show;
end;

procedure TC3.btnP2Click(Sender: TObject);
begin
P2STATS.show;
end;

procedure TC3.btnP3Click(Sender: TObject);
begin
P3STATS.show;
end;


procedure TC3.btnRDClick(Sender: TObject);
var
RD1: integer;
d: boolean;
begin
...
procedure TC3.Timer1Timer(Sender: TObject);
begin
